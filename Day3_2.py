...
def find_optimal_intersection_steps():
    min = 100000
    for intersection in mutual_coordinates:
        if intersection != (0, 0):
            steps1 = coordinates_wire1.index(intersection)
            steps2 = coordinates_wire2.index(intersection)
...
find_optimal_intersection_steps()